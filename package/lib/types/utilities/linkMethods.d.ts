...
import { ElementEvent, ValidationError, ValidationProperties } from "../core/Types";
/**
 * ---------------------------------------------------------------------------
 *
 * *** Linking Methods ***
 ...
 * @Hotpath
 */
declare function _linkFieldErrors<T extends Object>(errors: ValidationError[], field: FieldConfig<T>, error_display?: ValidationProperties<T>["error_display"], form_node?: HTMLFormElement): void;
/**
 ...
 * @Hotpath
 */
declare function _linkAllErrors<T extends Object>(errors: ValidationError[], fields: FieldConfig<T>[], error_display?: ValidationProperties<T>["error_display"], form_node?: HTMLFormElement): void;
/**
