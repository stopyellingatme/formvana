 ...
 */
export declare function _setValueChanges<T extends Object>(changes: Writable<Record<keyof T, any>>, field: FieldConfig<T>): void;
/**
...
export declare function _linkValues<ModelType extends Object>(from_fields_to_model: boolean, fields: FieldConfig<ModelType>[], model: ModelType): void;
/**
 ...
 */
export declare function _hanldeValueLinking<T extends Object>(model: T, fields: FieldConfig<T>[], link_fields_to_model: LinkOnEvent): void;
/**
 ...
 */
export declare function _handleFormValidation<T extends Object>(form: Form<T>, errors: ValidationError[], required_fields: Array<keyof T>, field?: FieldConfig<T>): Promise<ValidationError[]>;
/**
 ...
 */
export declare function _setFieldAttributes<T extends Object>(target_fields: Array<keyof T>, all_field_names: Array<keyof T>, fields: FieldConfig<T>[], attributes: Partial<FieldConfig<T>>): void;
/**
