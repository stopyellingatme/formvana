...
//#endregion
// #region Misc
type FieldNode<T extends Object> = (
  | HTMLInputElement
  | (HTMLElement & {
      type: string;
    })
...
declare function field<T extends Object>(
  config: Partial<FieldConfig<T>>
